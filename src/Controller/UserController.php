 ...
 */
public
function export(string $Subset, UserRepository $userRepository)
{
    $data = [];
    if ($Subset == 'All') {
 ...
 */
public
function userImport(Request $request, string $source, SluggerInterface $slugger, UserRepository $userRepository, UserImportOutlookService $userImportOutlookService, UserImportGrapevineService $userImportGrapevineService): Response
{
